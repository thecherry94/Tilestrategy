 ...
 *	  One way would be to completely remove the member _render_vertices. It contains ALL render information.
 *	  But why store information of something that is not visible?
 * 
 * 
 * TL;DR:
...
class Tilemap : public sf::Drawable, public sf::Transformable
{
	...
	private:
		...
		void update_map_vertices(unsigned int at_x, unsigned int at_y);
	...
	public:
		...
		void update_texture_map(unsigned int at_x, unsigned int at_y, std::vector<std::shared_ptr<Tile>> tile);
